...
#if 1/*1/*defined(CONFIG_PREEMPT_MONITOR)*/*/ && 1/*defined(CONFIG_MTPROF)*/
 ...
 * if !TRACE_IRQFLAGS.
 */
#if 1//#ifdef CONFIG_TRACE_IRQFLAGS_SUPPORT//CONFIG_TRACE_IRQFLAGS_SUPPORT=y
#if 1/*defined(CONFIG_PREEMPT_MONITOR)*/ && 1/*defined(CONFIG_MTPROF)*/
