...
//这里的exp是指自然对数e=2.718
//那么EXP_1=1/e^(5/60) * FIXED_1=1/2.718^(0.0833)*2048=1884
...
//TASK_UNINTERRUPTIBLE状态包括IO，等待网络，swap，内核中的锁竞争，内存直接页回收的睡眠，内核中一些代码路径上的主动阻塞等待资源
...
#endif
#if 1//#ifdef CONFIG_PREEMPT_MONITOR//CONFIG_PREEMPT_MONITOR=y
...
{
#if defined(CONFIG_DEBUG_ATOMIC_SLEEP) || !1/*defined()*/
	rcu_read_unlock();
	cond_resched();
	rcu_read_lock();
#endif
