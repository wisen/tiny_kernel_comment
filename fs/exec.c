...
static int exec_binprm(struct linux_binprm *bprm)
{
	...
	rcu_read_unlock();
//wisen: search_binary_handler==>fmt->load_binary==>load_elf_binary==>start_thread
...
//wisen: exec_binprm==>search_binary_handler==>fmt->load_binary==>load_elf_binary==>start_thread
