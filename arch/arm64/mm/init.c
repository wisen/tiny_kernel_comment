...
#if 0//#ifdef CONFIG_ZONE_MOVABLE_CMA//CONFIG_ZONE_MOVABLE_CMA is not set//CONFIG_ZONE_MOVABLE_CMA not set
#if 0
...
#if 1//#ifdef CONFIG_BLK_DEV_INITRD//CONFIG_BLK_DEV_INITRD=y//CONFIG_BLK_DEV_INITRD=y
	if (initrd_start) {
		memblock_reserve(__virt_to_phys(initrd_start), initrd_end - initrd_start);
		printk("wisen: initrd_start=%lu, initrd_end=%lu\n", initrd_start, initrd_end);
	}
#endif
...
#if 1//#ifndef CONFIG_SPARSEMEM_VMEMMAP
