		   ...
		   struct request *rq)
{
	 ...
	 */
	 //wisen: 不允许非RT的request去抢占RT的cfqq的时间片
 ...
 */
 //wien: cfq_rq_enqueued这个函数会处理优先级的request
static void
...
#ifdef CONFIG_CFQ_GROUP_IOSCHED//CONFIG_CFQ_GROUP_IOSCHED not set
#if 0
	if (!cfq_group_idle)
		cfq_group_idle = 1;
