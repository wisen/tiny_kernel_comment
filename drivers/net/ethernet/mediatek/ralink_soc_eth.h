...
#define FE_DELAY_CHAN		(((FE_DELAY_EN_INT | \
	FE_DELAY_MAX_INT) << 8) | FE_DELAY_MAX_TOUT)
...
#if defined(CONFIG_SOC_MT7621) || 0/*defined()*/ || \
defined(CONFIG_MACH_MT2701)
...
/* Switch MAC address LSB */
#define RT5350_SDM_MAC_ADRL	(RT5350_SDM_OFFSET + 0x0C)
/* Switch MAC Address MSB */
#define RT5350_SDM_MAC_ADRH	(RT5350_SDM_OFFSET + 0x10)
/* Switch DMA Tx packet count */
#define RT5350_SDM_TPCNT	(RT5350_SDM_OFFSET + 0x100)
/* Switch DMA Tx byte count */
#define RT5350_SDM_TBCNT	(RT5350_SDM_OFFSET + 0x104)
/* Switch DMA rx packet count */
#define RT5350_SDM_RPCNT	(RT5350_SDM_OFFSET + 0x108)
/* Switch DMA rx byte count */
#define RT5350_SDM_RBCNT	(RT5350_SDM_OFFSET + 0x10C)
/* Switch DMA rx checksum error count */
...
struct fe_hw_stats {
	spinlock_t stats_lock; /* lock fe_hw_stats */
...
struct fe_priv {
	spinlock_t page_lock;	/* lock fe_priv */
	...
	struct regulator *reg7530;
	struct clk *clk_ethif, *clk_esw, *clk_gp2, *clk_gp1, *clk_trgpll;
	struct pinctrl *reset_pin;
	struct pinctrl_state *reset_pin_default;
