...
#define TPD_KEYS_DIM            					{{160,1344,20,TPD_BUTTON_HEIGH}, {360,1344,20,TPD_BUTTON_HEIGH}, {570,1344,20,TPD_BUTTON_HEIGH}}
...
#define TPD_POWER_USE_REGULATOR
#define FTS_GESTRUE_EN 							1
#define MTK_EN 									1
#define FTS_APK_DEBUG
#define SYSFS_DEBUG
//#define TP_MONITOR_CTL
#define FT_TP									0
...
extern int gtp_enter_doze(struct i2c_client *client);
extern int gtp_leave_doze(struct i2c_client *client);
#endif
