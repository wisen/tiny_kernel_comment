...
#define TPD_KEYS        {KEY_APPSELECT, KEY_HOMEPAGE, KEY_BACK}//, KEY_SEARCH}
...
#endif
#if 0//#ifndef CONFIG_OF//CONFIG_OF=y_TOUCH
#else
...
#define GT91XX_PROC_FILE     "gtp_leather_mode"
