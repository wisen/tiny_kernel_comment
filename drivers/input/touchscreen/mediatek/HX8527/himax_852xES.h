...
//#define HX_FIX_MAX_PT //if it is enabled, MAX_PT would be set fixed value
...
static u8 		HW_RESET_ACTIVATE 	= 1;
	...
	#define HIMAX_PROC_FW_DEBUG_FILE	"state"
...
//#INT NOT response workaround on MTK platfrom_MT6735
