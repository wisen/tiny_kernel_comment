...
#define PKUP_FUN(f)		pr_debug(PKUP_TAG"%s\n", __func__)
#define PKUP_ERR(fmt, args...)	pr_err(PKUP_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define PKUP_LOG(fmt, args...)	pr_debug(PKUP_TAG fmt, ##args)
#define PKUP_VER(fmt, args...)  pr_debug(PKUP_TAG"%s: "fmt, __func__, ##args)	/* ((void)0) */
