...
/*add config gpio enp enn and rst by cheng.wang start 20160617*/
#ifdef CONFIG_H371
#define GPIO_LCD_BIAS_ENN_PIN (0x80000000|42)
#define GPIO_LCD_BIAS_ENP_PIN (0x80000000|83)
#define GPIO_LCM_RST (0x80000000|146)
#endif
/*add config gpio enp enn and rst by cheng.wang end 20160617*/
...
/*add gpio lcm rst by cheng.wang start 20160617*/
#elif defined(CONFIG_H371)
	if(value){
...
#else
	if (value) {
		//disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_RST_OUT1);
	}else {
		//disp_dts_gpio_select_state(DTS_GPIO_STATE_LCD_RST_OUT0);
	}
#endif
}
...
{
	long ret = 0;
/*add gpio enp by cheng.wang start 20160617*/
#if defined(CONFIG_MTK_LEGACY) || defined(CONFIG_H371)
/*add gpio enp by cheng.wang end 20160617*/
	if (value) {
		ret = mt_set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, 1);
	}else {
		ret = mt_set_gpio_out(GPIO_LCD_BIAS_ENP_PIN, 0);
	}
#else
	if (value) {
...
{
	long ret = 0;
/*add gpio enn by cheng.wang start 20160617*/
#if defined(CONFIG_MTK_LEGACY) || defined(CONFIG_H371)
/*add gpio enn by cheng.wang end 20160617*/
	if (value) {
		ret = mt_set_gpio_out(GPIO_LCD_BIAS_ENN_PIN, 1);
	}else {
		ret = mt_set_gpio_out(GPIO_LCD_BIAS_ENN_PIN, 0);
	}
#else
	if (value) {
