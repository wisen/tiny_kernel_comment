...
/*----------------------------------------------------------------------------*/
static const struct i2c_device_id akm09912_i2c_id[] = { {AKM09912_DEV_NAME, 0}, {} };
...
/*----------------------------------------------------------------------------*/
static int akm09912_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id);
static int akm09912_i2c_remove(struct i2c_client *client);
static int akm09912_i2c_detect(struct i2c_client *client, struct i2c_board_info *info);
...
static void AKECS_SaveData(int *buf)
{
	...
	if (atomic_read(&data->trace) & AMK_HWM_DEBUG) {
		MAGN_LOG("Get daemon data: %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d!\n",
		...
		MAGN_LOG("Get daemon data: %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d!\n",
...
TEST_DATA(const char testno[],
	  const char testname[], const int testdata, const int lolimit, const int hilimit, int *pf_total)
{
	int pf = 0;
...
int FST_AK8963(void)
{
	...
	TEST_DATA(TLIMIT_NO_RST_WIA, TLIMIT_TN_RST_WIA, (int)i2cData[0], TLIMIT_LO_RST_WIA, TLIMIT_HI_RST_WIA,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_INFO, TLIMIT_TN_RST_INFO, (int)i2cData[1], TLIMIT_LO_RST_INFO, TLIMIT_HI_RST_INFO,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_ST1, TLIMIT_TN_RST_ST1, (int)i2cData[2], TLIMIT_LO_RST_ST1, TLIMIT_HI_RST_ST1,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_HXL, TLIMIT_TN_RST_HXL, (int)i2cData[3], TLIMIT_LO_RST_HXL, TLIMIT_HI_RST_HXL,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_HXH, TLIMIT_TN_RST_HXH, (int)i2cData[4], TLIMIT_LO_RST_HXH, TLIMIT_HI_RST_HXH,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_HYL, TLIMIT_TN_RST_HYL, (int)i2cData[5], TLIMIT_LO_RST_HYL, TLIMIT_HI_RST_HYL,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_HYH, TLIMIT_TN_RST_HYH, (int)i2cData[6], TLIMIT_LO_RST_HYH, TLIMIT_HI_RST_HYH,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_RST_HZL, TLIMIT_TN_RST_HZL, (int)i2cData[7], TLIMIT_LO_RST_HZL, TLIMIT_HI_RST_HZL,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_HZH, TLIMIT_TN_RST_HZH, (int)i2cData[8], TLIMIT_LO_RST_HZH, TLIMIT_HI_RST_HZH,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_ST2, TLIMIT_TN_RST_ST2, (int)i2cData[9], TLIMIT_LO_RST_ST2, TLIMIT_HI_RST_ST2,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_CNTL, TLIMIT_TN_RST_CNTL, (int)i2cData[10], TLIMIT_LO_RST_CNTL, TLIMIT_HI_RST_CNTL,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_RST_ASTC, TLIMIT_TN_RST_ASTC, (int)i2cData[12], TLIMIT_LO_RST_ASTC, TLIMIT_HI_RST_ASTC,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_WR_CNTL, TLIMIT_TN_WR_CNTL, (int)i2cData[0], TLIMIT_LO_WR_CNTL, TLIMIT_HI_WR_CNTL,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_SNG_ST1, TLIMIT_TN_SNG_ST1, (int)i2cData[0], TLIMIT_LO_SNG_ST1, TLIMIT_HI_SNG_ST1,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_SNG_ST2, TLIMIT_TN_SNG_ST2, (int)i2cData[8], TLIMIT_LO_SNG_ST2, TLIMIT_HI_SNG_ST2,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_SLF_ST1, TLIMIT_TN_SLF_ST1, (int)i2cData[0], TLIMIT_LO_SLF_ST1, TLIMIT_HI_SLF_ST1,
		  &pf_total);
	...
	TEST_DATA(TLIMIT_NO_SLF_RVHX,
		  TLIMIT_TN_SLF_RVHX,
		  (hdata[0]) * ((asax - 128) / 2 / 128 + 1), TLIMIT_LO_SLF_RVHX, TLIMIT_HI_SLF_RVHX, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHY,
		  TLIMIT_TN_SLF_RVHY,
		  (hdata[1]) * ((asay - 128) / 2 / 128 + 1), TLIMIT_LO_SLF_RVHY, TLIMIT_HI_SLF_RVHY, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHZ,
		  TLIMIT_TN_SLF_RVHZ,
		  (hdata[2]) * ((asaz - 128) / 2 / 128 + 1), TLIMIT_LO_SLF_RVHZ, TLIMIT_HI_SLF_RVHZ, &pf_total);
	TEST_DATA(TLIMIT_NO_SLF_ST2, TLIMIT_TN_SLF_ST2, (int)i2cData[8], TLIMIT_LO_SLF_ST2, TLIMIT_HI_SLF_ST2,
		  &pf_total);
...
int FST_AK09912(void)
{
	...
	TEST_DATA(TLIMIT_NO_RST_WIA1_09912, TLIMIT_TN_RST_WIA1_09912, (int)i2cData[0], TLIMIT_LO_RST_WIA1_09912,
		  TLIMIT_HI_RST_WIA1_09912, &pf_total);
	TEST_DATA(TLIMIT_NO_RST_WIA2_09912, TLIMIT_TN_RST_WIA2_09912, (int)i2cData[1], TLIMIT_LO_RST_WIA2_09912,
	...
	TEST_DATA(TLIMIT_NO_WR_CNTL2_09912, TLIMIT_TN_WR_CNTL2_09912, (int)i2cData[0], TLIMIT_LO_WR_CNTL2_09912,
	...
	TEST_DATA(TLIMIT_NO_ASAX_09912, TLIMIT_TN_ASAX_09912, asax, TLIMIT_LO_ASAX_09912, TLIMIT_HI_ASAX_09912,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_ASAY_09912, TLIMIT_TN_ASAY_09912, asay, TLIMIT_LO_ASAY_09912, TLIMIT_HI_ASAY_09912,
		  &pf_total);
	TEST_DATA(TLIMIT_NO_ASAZ_09912, TLIMIT_TN_ASAZ_09912, asaz, TLIMIT_LO_ASAZ_09912, TLIMIT_HI_ASAZ_09912,
		  &pf_total);
	...
	i2cData[0] &= 0x7F;
	TEST_DATA(TLIMIT_NO_SNG_ST1_09912, TLIMIT_TN_SNG_ST1_09912, (int)i2cData[0], TLIMIT_LO_SNG_ST1_09912,
		  TLIMIT_HI_SNG_ST1_09912, &pf_total);

	TEST_DATA(TLIMIT_NO_SNG_HX_09912, TLIMIT_TN_SNG_HX_09912, hdata[0], TLIMIT_LO_SNG_HX_09912,
		  TLIMIT_HI_SNG_HX_09912, &pf_total);
	TEST_DATA(TLIMIT_NO_SNG_HY_09912, TLIMIT_TN_SNG_HY_09912, hdata[1], TLIMIT_LO_SNG_HY_09912,
		  TLIMIT_HI_SNG_HY_09912, &pf_total);
	TEST_DATA(TLIMIT_NO_SNG_HZ_09912, TLIMIT_TN_SNG_HZ_09912, hdata[2], TLIMIT_LO_SNG_HZ_09912,
		  TLIMIT_HI_SNG_HZ_09912, &pf_total);
	TEST_DATA(TLIMIT_NO_SNG_ST2_09912, TLIMIT_TN_SNG_ST2_09912, (int)i2cData[8], TLIMIT_LO_SNG_ST2_09912,
	...
	i2cData[0] &= 0x7F;
	TEST_DATA(TLIMIT_NO_SLF_ST1_09912, TLIMIT_TN_SLF_ST1_09912, (int)i2cData[0], TLIMIT_LO_SLF_ST1_09912,
	...
	TEST_DATA(TLIMIT_NO_SLF_RVHX_09912,
		  ...
		  (hdata[0]) * ((asax - 128) / 256 + 1), TLIMIT_LO_SLF_RVHX_09912, TLIMIT_HI_SLF_RVHX_09912, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHY_09912,
		  TLIMIT_TN_SLF_RVHY_09912,
		  (hdata[1]) * ((asay - 128) / 256 + 1), TLIMIT_LO_SLF_RVHY_09912, TLIMIT_HI_SLF_RVHY_09912, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_RVHZ_09912,
		  TLIMIT_TN_SLF_RVHZ_09912,
		  (hdata[2]) * ((asaz - 128) / 256 + 1), TLIMIT_LO_SLF_RVHZ_09912, TLIMIT_HI_SLF_RVHZ_09912, &pf_total);

	TEST_DATA(TLIMIT_NO_SLF_ST2_09912,
		  TLIMIT_TN_SLF_ST2_09912,
		  (int)i2cData[8], TLIMIT_LO_SLF_ST2_09912, TLIMIT_HI_SLF_ST2_09912, &pf_total);
...
{
	int idx = 0, err = 0;
	int num = (int)(sizeof(akm09912_attr_list) / sizeof(akm09912_attr_list[0]));
...
/*----------------------------------------------------------------------------*/
static long akm09912_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
...
static long akm09912_compat_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	long ret = 0;
	...
	case COMPAT_ECS_IOCTL_SET_YPR_09911:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_SET_YPR_09911, (unsigned long)(arg32));
		if (ret) {
	...
	case COMPAT_ECS_IOCTL_GET_OPEN_STATUS:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_GET_OPEN_STATUS, (unsigned long)(arg32));
		if (ret) {
	...
	case COMPAT_ECS_IOCTL_GET_CLOSE_STATUS:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_GET_CLOSE_STATUS, (unsigned long)(arg32));
		if (ret) {
	...
	case COMPAT_ECS_IOCTL_GET_OSENSOR_STATUS:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_GET_OSENSOR_STATUS, (unsigned long)(arg32));
		if (ret) {
	...
	case COMPAT_ECS_IOCTL_GET_DELAY_09911:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_GET_DELAY_09911, (unsigned long)(arg32));
		if (ret) {
	...
	case COMPAT_ECS_IOCTL_GET_LAYOUT_09911:
		ret = file->f_op->unlocked_ioctl(file, ECS_IOCTL_GET_LAYOUT_09911, (unsigned long)arg32);
		if (ret) {
...
{
	struct akm09912_i2c_data *obj = container_of(h, struct akm09912_i2c_data, early_drv);
	int err = 0;
...
static int akm09912_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if (err < 0) {
		MAG_ERR("AKM09912 akm09912_probe: check device connect error\n");
		goto exit_init_failed;
	}

	/* Register sysfs attribute */
	err = akm09912_create_attr(&(akm09912_init_info.platform_diver_addr->driver));
	if (err) {
...
static int akm09912_i2c_remove(struct i2c_client *client)
{
	...
	err = akm09912_delete_attr(&(akm09912_init_info.platform_diver_addr->driver));
	if (err)
