...
#define MMC3524x_I2C_ADDR		0x30//0x60	// 8-bit    7-bit  0x30
...
#define CONVERT_GY_DIV          262144
#define CONVERT_VEC		       32
#define CONVERT_VECTOR_DIV	262144
#define CONVERT_GRV		       32
#define CONVERT_GRV_DIV	    262144
#define CONVERT_LINACC		       32
#define CONVERT_LINACC_DIV	    262144
#define GRAVITY_FACTOR          9807
//Add end by MEMSIC for gyro
...
//Add for MMC3524X IOCTRL
#define MMC3524X_IOC_READ_REG					_IOR(MSENSOR, 0x23, unsigned char)
...
#define COMPAT_MMC3524X_IOC_READ_REG		_IOR(MSENSOR, 0x23, unsigned char)
