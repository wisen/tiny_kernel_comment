...
#ifndef _bq24259_SW_H_
#define _bq24259_SW_H_

#define bq24259_CON0      0x00
#define bq24259_CON1      0x01
#define bq24259_CON2      0x02
#define bq24259_CON3      0x03
#define bq24259_CON4      0x04
#define bq24259_CON5      0x05
#define bq24259_CON6      0x06
#define bq24259_CON7      0x07
#define bq24259_CON8      0x08
#define bq24259_CON9      0x09
#define bq24259_CON10      0x0A
#define bq24259_REG_NUM 11
...
extern void bq24259_set_vindpm(unsigned int val);
extern void bq24259_set_iinlim(unsigned int val);
/* CON1---------------------------------------------------- */
extern void bq24259_set_reg_rst(unsigned int val);
extern void bq24259_set_wdt_rst(unsigned int val);
extern void bq24259_set_chg_config(unsigned int val);
extern void bq24259_set_otg_config(unsigned int val);
extern void bq24259_set_sys_min(unsigned int val);
extern void bq24259_set_boost_lim(unsigned int val);
/* CON2---------------------------------------------------- */
extern void bq24259_set_ichg(unsigned int val);
extern void bq24259_set_bcold(unsigned int val);
extern void bq24259_set_force_20pct(unsigned int val);
/* CON3---------------------------------------------------- */
extern void bq24259_set_iprechg(unsigned int val);
extern void bq24259_set_iterm(unsigned int val);
/* CON4---------------------------------------------------- */
extern void bq24259_set_vreg(unsigned int val);
extern void bq24259_set_batlowv(unsigned int val);
extern void bq24259_set_vrechg(unsigned int val);
/* CON5---------------------------------------------------- */
extern void bq24259_set_en_term(unsigned int val);
extern void bq24259_set_watchdog(unsigned int val);
extern void bq24259_set_en_timer(unsigned int val);
extern void bq24259_set_chg_timer(unsigned int val);
/* CON6---------------------------------------------------- */
extern void bq24259_set_treg(unsigned int val);
extern void bq24259_set_boostv(unsigned int val);
extern void bq24259_set_bhot(unsigned int val);
/* CON7---------------------------------------------------- */
extern void bq24259_set_tmr2x_en(unsigned int val);
extern void bq24259_set_batfet_disable(unsigned int val);
extern void bq24259_set_int_mask(unsigned int val);
/* CON8---------------------------------------------------- */
extern unsigned int bq24259_get_system_status(void);
extern unsigned int bq24259_get_vbus_stat(void);
extern unsigned int bq24259_get_chrg_stat(void);
extern unsigned int bq24259_get_vsys_stat(void);
/* --------------------------------------------------------- */
extern void bq24259_dump_register(void);
extern unsigned int bq24259_reg_config_interface(unsigned char RegNum, unsigned char val);

extern unsigned int bq24259_read_interface(unsigned char RegNum, unsigned char *val, unsigned char MASK,
					 unsigned char SHIFT);
extern unsigned int bq24259_config_interface(unsigned char RegNum, unsigned char val, unsigned char MASK,
					   unsigned char SHIFT);
#endif				/* _bq24259_SW_H_ */
