...
//mtk的6753有个设计缺陷，虽然它是8*A53 1.3GHz架构，但是它的PMIC跟不上，最多可以
//同时供6个核，如果8核同时就降频到1.1GHz
#if 0//#ifdef CONFIG_ARCH_MT6753//
...
/* CPU on/off callback */
#if 0/*defined()*/ || defined(CONFIG_CPU_DVFS_TURBO_MODE)
...
#if 0/*defined()*/ && defined(CONFIG_MTK_EFUSE_DOWNGRADE)
