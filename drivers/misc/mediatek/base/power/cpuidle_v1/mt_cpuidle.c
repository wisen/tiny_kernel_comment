...
#endif
#if defined(CONFIG_TRUSTY) && 1/*defined()*/
...
#if defined(CONFIG_ARCH_MT6735_SERIES) || 1/*defined()*/
...
#elif 0/*defined()*/ || defined(CONFIG_ARCH_MT6797)
...
#if !defined(CONFIG_ARM64) && !1/*defined()*/
...
#elif defined(CONFIG_TRUSTY) && 1/*defined()*/
	if (cpuid == 0)
...
#if !1/*defined()*/
#if 0/*defined()*/ || defined(CONFIG_MTK_PSCI)
