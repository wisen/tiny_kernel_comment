 ...
 */
#define MAX_INIT_ARGS 32/*CONFIG_INIT_ENV_ARG_LIMIT=32*/
#define MAX_INIT_ENVS 32/*CONFIG_INIT_ENV_ARG_LIMIT=32*/
...
#if 0//#ifndef CONFIG_SMP//CONFIG_SMP=y
...
static void __init mm_init(void)
{
	 ...
	 */
	page_cgroup_init_flatmem();//CONFIG_MEMCG未配置直接返回
